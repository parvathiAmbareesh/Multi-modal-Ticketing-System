...
public class staffhomecar extends AppCompatActivity {
    Button b1,b2,b3,b4,b5,b6,b7;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_staffhomecar);
    ...
    public void onBackPressed()
    {
        ...
        super.onBackPressed();
        Intent b=new Intent(getApplicationContext(),staffhomecar.class);
        startActivity(b);
    }
    }
