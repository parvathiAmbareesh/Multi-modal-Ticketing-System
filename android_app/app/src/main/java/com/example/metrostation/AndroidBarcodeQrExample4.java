...
//					startActivity(new Intent(getApplicationContext(), Userhome.class));
				...
				String q="/AndroidBarcodeQrExample4?contents="+contents+"&latitude="+tolatti +"&longitude="+tolongi+ "&logid=" + sh.getString("log_id", "")+"&rid="+Userfirstrequestview.rid +"&amtss="+Userfirstrequestview.amtss+"&place="+Addplace.places;
				q=q.replace(" ","%20");
				JR.execute(q);
