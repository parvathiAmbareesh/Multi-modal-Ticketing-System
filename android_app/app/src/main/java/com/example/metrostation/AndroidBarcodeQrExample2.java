...
public class AndroidBarcodeQrExample2 extends Activity implements JsonResponse
{
	...
	public void scanBar(View v) {
		try {
			...
			showDialog(AndroidBarcodeQrExample2.this, "No Scanner Found", "Download a scanner code activity?", "Yes", "No").show();
		}
	}
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		if (requestCode == 0) {
			if (resultCode == RESULT_OK) {
				...
				JR.json_response=(JsonResponse) AndroidBarcodeQrExample2.this;
	...
	public void response(JSONObject jo) {
		try {
			...
			if (status.equalsIgnoreCase("success")) {
				...
				startService(new Intent(getApplicationContext(),staffhomeboat.class));
